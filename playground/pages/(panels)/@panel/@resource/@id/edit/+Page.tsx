...
export default function EditPage() {
  ...
  const { connected, presences, setCollaborativeValue, syncAllFieldsToDoc, getYText, awareness } = useCollaborativeForm(
  ...
  function renderField(field: FieldMeta) {
    ...
    return (
      <div key={field.name}>
        ...
        <FieldInput field={field} value={values[field.name]} onChange={(v: unknown) => setValue(field.name, v)} uploadBase={uploadBase} i18n={i18n} disabled={fieldDisabled} yText={field.collaborative ? getYText(field.name) : null} awareness={field.collaborative ? awareness : null} />
