/**
 * `pnpm rudder ai:eval` CLI handler tests.
 *
 * Covers:
 ...
 * milliseconds without API keys. The eval framework (`runSuite`,
 * reporters, fixtures) is consumed from `@gemstack/ai-sdk/eval`.
 */
...
import { Agent, AiFake } from '@gemstack/ai-sdk'
import { evalSuite, exactMatch, type EvalSuite } from '@gemstack/ai-sdk/eval'
import {
  parseArgs,
  discoverSuiteFiles,
  runEvalCli,
