...
- aed4860: feat(sync/collab): add four row-array primitives blocking clean adoption
...
- df2c72d: feat(sync): collaborative row-array binding (repeatable rows with stable identity + reorder)
