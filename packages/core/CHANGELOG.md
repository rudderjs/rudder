...
- a7c4d0a: Harden the DI container and provider discovery:
...
- a2fd198: fix(core): make `maintenance.js` client-eval-safe so it no longer crashes browser bundles
