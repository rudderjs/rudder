...
- View scanner generates Vike pages at `pages/__view/` from `app/Views/`; the typed-view registry + route/model registries land in `.rudder/types/` (see `src/rudder-dir.ts`)
