...
- f3836a6: Close the three deferred cache hardening gaps from the security dive.
...
- 71a8237: Harden the cache integrity backbone against counter poisoning, a lock-wait hang, and default-driver memory exhaustion.
