...
| `@rudderjs/orm` | `migrate`, `migrate:fresh`, `migrate:status`, `make:migration`, `schema:types`, `make:factory`, `make:seeder`, `db:push`, `db:generate`, `db:show`, `db:table`, `model:prune` |
