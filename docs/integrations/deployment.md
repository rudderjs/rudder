...
Forge runs natively on Node.js 18+. The Hono adapter starts a Node.js HTTP server automatically.
...
Forge's WinterCG-compatible entry point works on Cloudflare Workers.
