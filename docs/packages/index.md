...
| [@boostkit/localization](./localization) | Laravel-style i18n with JSON files, `__()`, `trans()`, interpolation, pluralization, fallback locale, and per-request locale context. | `pnpm add @boostkit/localization` |
