...
test('getTemplates() output is byte-stable across refactor', () => {
  ...
  // Baseline last captured 2026-06-18: standardized @rudderjs/vite import name
  // to `rudder` (was `rudderjs`). Same file set.
...
const EXPECTED_TOTAL_BYTES = 51412
const EXPECTED_CONTENT_HASH = '0a81f70f4d1b8d3a3d11671c9faac33a3cd8e49b27798e76feed7c87a3dd6b6a'
